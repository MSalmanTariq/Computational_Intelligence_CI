    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            do{
                ...
                learningRate = Number (1/Number(1+epochCount));
              ...
              /*   mainError.push(errors[errors.length-1]);
                if(mainError.length!==1){
                    calcError = Number( mainError[mainError.length-1] -  mainError[mainError.length-2] )
                } */
              
              /*   console.log("Main Error: "+mainError[mainError.length-1]); */
              console.log("Main Error: "+avgErr);
                console.log("epoch: "+epochCount+" completed!\n\n");
                epochCount++;
            }
           /*  while(Number(calcError)>0.001) */
           while(Number(avgErr)>0.000001)
           console.log('Testing');
           for(tuple=1;tuple<arr.length;tuple++){
